...
if __name__ == "__main__":
    ...
    # 1. 加载数据、标签
    test_dataset, val_dataset, num_classes = load_data_and_onehot_label(data_path="./Data/Test_Data.mat", label_path="./Data/Test_Label.mat", test_split=0.4)
    train_dataset, num_classes = Train_data_Gen(data_path="./Data/Train_Data.mat", label_path="./Data/Train_Label.mat")
    # 从测试集中划分验证集
